package com.flinkparty.analytics.chapter3;
...
public class UsingJoins {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ClassLoader classLoader = UsingJoins.class.getClassLoader();
            ...
            TableSource vendorSource
                    ...
                    .path(String.valueOf(classLoader.getResource("data/batch/product_vendor.csv")))
                    .ignoreFirstLine()
                    .field("Product", Types.STRING)
