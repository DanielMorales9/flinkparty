...
import com.flinkparty.analytics.chapter2.BasicBatchAnalytics;
...
public class WorkingWithDatasets {
    ...
    public static void main(String[] args) {
        ...
        try {
             ...
             ****************************************************************************/
            ClassLoader classLoader = WorkingWithDatasets.class.getClassLoader();
            ...
            DataSet<Tuple7<Integer,String, String, String,
                    ...
                    = batchEnv.readCsvFile(String.valueOf(classLoader.getResource("data/batch/sales_orders.csv")))
                        .ignoreFirstLine()
                        .parseQuotedStrings('\"')
