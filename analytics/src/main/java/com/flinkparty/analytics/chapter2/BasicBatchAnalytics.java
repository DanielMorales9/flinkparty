package com.flinkparty.analytics.chapter2;

import com.flinkparty.analytics.common.Utils;
...
public class BasicBatchAnalytics {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ClassLoader classLoader = BasicBatchAnalytics.class.getClassLoader();

            TableSource salesSource
                    = new CsvTableSource.Builder()  //Type = CSV
                    .path(String.valueOf(classLoader.getResource("data/batch/sales_orders.csv")))  //Path for the Source
            ...
            Table salesTable = batchTableEnv.scan("product_sales");
            ...
            Table selectAPI = salesTable.select("Customer, Product, Quantity, Rate");

            Utils.printBatchTable(batchTableEnv,selectAPI,"SELECT using Table API");

            //Using SQL for Select
            Table selectSQL = batchTableEnv.sqlQuery("SELECT Customer, Product, Quantity, Rate"
                                    + " FROM product_sales");
            ...
            TableSink<Row> summarySink
                    ...
                    = new CsvTableSink(
                        String.valueOf(classLoader.getResource("data/file_sink/MouseSales.csv")),  //Destination File
                        ",",                //Field Delimiter
