package com.flinkparty.batch.chapter3;
...
public class BasicTransformations {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ClassLoader classLoader = BasicTransformations.class.getClassLoader();

            DataSet<Tuple7<Integer,String, String, String,
                                        Integer, Double, String>> rawOrders

                    = env.readCsvFile(String.valueOf(classLoader.getResource("sales_orders.csv")))
                            .ignoreFirstLine()
                            .parseQuotedStrings('\"')
            ...
            productOrderSummary
                    .map((MapFunction<Tuple3<String, Integer, Double>, Tuple2<String, Double>>) summary -> {
                            return new Tuple2(
